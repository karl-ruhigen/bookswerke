...
`Заметки, которые могли бы быть написаны отставным филологом, которого внуки заставили играть в (Detroit: Become Human)[https://ru.wikipedia.org/wiki/Detroit:_Become_Human]`
...
Толпы инопланетян, самых разных форм и оттеноков - туда же. Все эти толпы галактических захватчиков и межзведных королей - все их поведение совершенно типично для наших представлений, отличается только биология и технические возможности.
